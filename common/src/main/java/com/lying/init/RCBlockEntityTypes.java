...
public class RCBlockEntityTypes
{
	...
	public static final RegistrySupplier<BlockEntityType<RaggedBannerBlockEntity>> RAGGED_BANNER	= register("ragged_banner", RaggedBannerBlockEntity::new, RCBlocks.getAllBanners());
	...
	{
		tally++;
		return TYPES.register(prefix(nameIn), () -> new BlockEntityType<>(supplierIn, Set.of(blocksIn)));
	}
