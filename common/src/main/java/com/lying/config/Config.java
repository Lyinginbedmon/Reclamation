...
public abstract class Config
{
	...
	public void read()
	{
		...
		{
			Reclamation.LOGGER.error("Generated new config file "+fileName);
			save();
			return;
		}
		catch(IOException e)
		{
			Reclamation.LOGGER.error("Couldn't read config file "+fileName);
			e.printStackTrace();
		}
	...
	public void save()
	{
		try
		{
			...
			writer.close();
			if(!fileExists)
				Reclamation.LOGGER.info("Generated new config file "+fileName);
		}
		catch(IOException e)
		{
			Reclamation.LOGGER.error("Couldn't read config file "+fileName);
